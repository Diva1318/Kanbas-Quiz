...
// import { addAnswer, updateAnswer } from './AnswerReducer' // Adjust as per your Redux setup
// import './style.css'
...
//   const [highestScoreAnswers, setHighestScoreAnswers] = useState<Answers>({}) // Answers for highest score
...
//     // Logic to store answers in the database
//     try {
//       const existingAnswers = await questionClient.findAllQuestionsByQuizId(
//         qid as string
//       ) // Fetch existing answers
//       const userAnswers = existingAnswers.filter(
//         (answer: any) =>
//           answer.userId === currentUser?.userId && answer.quizId === qid
//       )
...
//           await questionClient.updateQuestion(answerData) // Assuming this function updates the answer in your backend
//           dispatch(updateAnswer(answerData)) // Update answer in Redux state
//         } else {
//           // Create new answer
//           await questionClient.createQuestion(qid as string, answerData) // Assuming this function creates a new answer in your backend
//           dispatch(addAnswer(answerData)) // Add answer to Redux state
//         }
//       }
//     } catch (error) {
...
//     if (
//       option === questions.find((q: any) => q._id === questionId)?.answers[0]
//     ) {
//       alert('Correct!')
//     } else {
//       alert('Incorrect!')
    ...
    try {
      for (let question of questions) {
        ...
        if (existingAnswer) {
          ...
          // Create new answer
          await answerClient.createAnswer(answerData)
          dispatch(addAnswer(answerData)) // Add answer to Redux state
        }
      }
    } catch (error) {
