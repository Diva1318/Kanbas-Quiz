...
//   //   if (qid && qid !== 'New') {
//   //     try {
//   //       console.log(`Fetching quiz details for course ID: ${cid}, quiz ID: ${qid}`);
//   //       const quiz = await client.findQuiz(cid as string, qid as string);
//   //       setQuizDetails({
//   //         title: quiz.title,
//   //         instructions: quiz.instructions,
...
//       [name]: type === 'checkbox' ? checked : value
//     })
//     console.log('Setting new value for checkbox)')
//   }
...
//         const newQuiz = await client.createQuizzes(cid as string, quizDetails)
//         console.log('New QuizID:' + newQuiz._id)
